...
export const getUsersForSidebar = async (req,res) => {
    try {
        ...
        res.json({ success: true, users: filteredUsers, unseenMessages, message: "Users fetched successfully" });
    } catch (error) {
...
export const sendMessage = async (req, res) => {
    try {
        ...
        res.json({ success: true, newMessage, message: "Message sent successfully" });
    } catch (error) {
        console.log(error.message);
        res.json({success:false,message:error.message})
